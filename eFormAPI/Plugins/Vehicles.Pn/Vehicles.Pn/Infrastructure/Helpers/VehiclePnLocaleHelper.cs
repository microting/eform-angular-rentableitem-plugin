namespace Vehicles.Pn.Infrastructure.Helpers
{
    public static class VehiclePnLocaleHelper
    {
        ...
        {
            var message = format;// VehiclePnResources.ResourceManager.GetString(format, Thread.CurrentThread.CurrentCulture);
            if (message == null)
            {
                return null;
            }
