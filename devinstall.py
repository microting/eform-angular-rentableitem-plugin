...
# Define paths
src_base = os.path.join("Documents", "workspace", "microting", "eform-angular-rentableitem-plugin")
dst_base = os.path.join("Documents", "workspace", "microting", "eform-angular-frontend")

# Remove and copy main directories
paths = [
    (os.path.join("eform-client", "src", "app", "plugins", "modules", "rentable-items-pn"),
     os.path.join("eform-client", "src", "app", "plugins", "modules", "rentable-items-pn")),
    (os.path.join("eFormAPI", "Plugins", "RentableItems.Pn"),
     os.path.join("eFormAPI", "Plugins", "RentableItems.Pn")),
]
...
test_files_to_remove = [
    os.path.join("eform-client", "e2e", "Tests", "rentableitem-settings"),
    os.path.join("eform-client", "e2e", "Tests", "rentableitem-general"),
    os.path.join("eform-client", "e2e", "Page objects", "rentableitem-general"),
